...
(function (factory) {
  ...
  var factoryOutput = (() => {
    ...
    var R2 = (m, e) => {
        for (var n in e) v1(m, n, { get: e[n], enumerable: !0 });
      },
      O2 = (m, e, n, r) => {
        if ((e && typeof e == "object") || typeof e == "function")
          for (let u of P2(e))
            !x2.call(m, u) &&
              ...
              v1(m, u, {
                get: () => e[u],
                enumerable: !(r = D2(e, u)) || r.enumerable,
              });
        return m;
      };
    var k2 = (m) => O2(v1({}, "__esModule", { value: !0 }), m);
    var z2 = {};
    R2(z2, { default: () => W2 });
    var i2 = [
        ["af", "93"],
    ...
    var H2 = { ...o2, ...s2 },
      I1 = H2;
    for (let m = 0; m < K.length; m++) K[m].name = I1[K[m].iso2];
    var U2 = 0,
      l2 = {
        allowDropdown: !0,
      ...
      K2 = (m, e, n, r) => {
        ...
        for (let l = 0; l < e.length; l++) {
          if ((/[+0-9]/.test(e[l]) && u++, u === m && !r)) return l + 1;
          if (r && u === m + 1) return l;
        }
        return e.length;
      },
      L = (m, e, n) => {
        let r = document.createElement(m);
        return (
      ...
      _1 = class {
        constructor(e, n = {}) {
          (this.id = U2++),
            ...
            (this.options = Object.assign({}, l2, n)),
        ...
        _init() {
          ...
          (this.showSelectedCountryOnLeft = this.isRTL ? !e : e),
            ...
            (this.options.i18n = { ...I1, ...this.options.i18n });
        ...
        _processAllCountries() {
          ...
          if (e.length) {
            ...
            this.countries = K.filter((u) => r.indexOf(u.iso2) > -1);
          } else if (n.length) {
            ...
            if (n.areaCodes) {
              ...
              for (let u = 0; u < n.areaCodes.length; u++) {
                ...
                for (let p = 1; p < l.length; p++) {
                  let y = n.dialCode + l.substr(0, p);
                  this._addToDialCodeMap(r, y),
                    this._addToDialCodeMap(n.iso2, y);
                }
        ...
        _generateMarkup() {
          ...
          let {
            ...
            T = "iti";
          e && (T += " iti--allow-dropdown"),
            r && (T += " iti--show-flags"),
            u && (T += ` ${u}`),
            C || (T += " iti--inline-dropdown");
          let b = L("div", { class: T });
          if (
            ...
            if (
              ...
              let M = y ? "" : "iti--flexible-dropdown-width";
              if (
                ...
                C
                  ? (k += " iti--fullscreen-popup")
                  : (k += " iti--inline-dropdown"),
                  (this.dropdown = L("div", { class: k })),
          ...
          if ((b.appendChild(this.telInput), this._updateInputPadding(), l)) {
            let O = this.telInput.getAttribute("name") || "",
              M = l(O);
            M.phone &&
              ((this.hiddenInput = L("input", {
                type: "hidden",
                name: M.phone,
              })),
        ...
        _setInitialState(e = !1) {
          let n = this.telInput.getAttribute("value"),
            ...
            y = a2(l),
            { initialCountry: C, geoIpLookup: S } = this.options,
            I = C === "auto" && S;
          if (p && !y) this._updateCountryFromNumber(l);
          else if (!I || e) {
            let T = C ? C.toLowerCase() : "";
        ...
        _loadAutoCountry() {
          g.autoCountry
            ...
            : g.startedLoadingAutoCountry ||
              ((g.startedLoadingAutoCountry = !0),
                ...
                this.options.geoIpLookup(
                  (e = "") => {
                    ...
                    n && this._getCountryData(n, !0)
                      ? ((g.autoCountry = n),
                        setTimeout(() => $1("handleAutoCountry")))
                      : (this._setInitialState(!0),
                        $1("rejectAutoCountryPromise"));
                  },
                  () => {
        ...
        _initTelInputListeners() {
          ...
          /\p{L}/u.test(this.telInput.value) && (y = !0),
            (this._handleInputEvent = (C) => {
              if (this.isAndroid && C?.data === "+" && r && l && p) {
                let b = this.telInput.selectionStart || 0,
                  O = this.telInput.value.substring(0, b - 1),
                  M = this.telInput.value.substring(b);
                (this.telInput.value = O + M), this._openDropdownWithPlus();
                return;
              }
              this._updateCountryFromNumber(this.telInput.value) &&
                this._triggerCountryChange();
              let S = C?.data && /[^+0-9]/.test(C.data),
                I = C?.inputType === "insertFromPaste" && this.telInput.value;
              S || (I && !e)
                ? (y = !0)
                : /[^+0-9]/.test(this.telInput.value) || (y = !1);
              let T = C?.detail && C.detail.isSetNumber && !u;
              if (n && !y && !T) {
                let b = this.telInput.selectionStart || 0,
                  M = this.telInput.value
                    .substring(0, b)
                    .replace(/[^+0-9]/g, "").length,
                  k = C?.inputType === "deleteContentForward",
                  z = this._formatNumberAsYouType(),
                  J = K2(M, z, b, k);
                (this.telInput.value = z),
                  this.telInput.setSelectionRange(J, J);
              }
            }),
            this.telInput.addEventListener("input", this._handleInputEvent),
            (e || r) &&
              ((this._handleKeydownEvent = (C) => {
                if (
                  C.key &&
                  C.key.length === 1 &&
                  !C.altKey &&
                  ...
                  if (e) {
                    let S = this.telInput.selectionStart === 0 && C.key === "+",
                      I = /^[0-9]$/.test(C.key),
                      T = r ? I : S || I,
                      b = this._getFullNumber(),
                      O = g.utils.getCoreNumber(
                        b,
                      ...
                      k = this.telInput.value.substring(
        ...
        _updateValFromNumber(e) {
          ...
          if (
            ...
            let r =
              ...
              { NATIONAL: u, INTERNATIONAL: l } = g.utils.numberFormat,
              p = r ? u : l;
            n = g.utils.formatNumber(n, this.selectedCountryData.iso2, p);
          }
        ...
        _updateCountryFromNumber(e) {
          ...
          let p = this._getDialCode(r, !0),
            ...
            C = null;
          if (p) {
            let S = this.dialCodeToIso2Map[c1(p)],
              I =
                S.indexOf(this.selectedCountryData.iso2) !== -1 &&
                y.length <= p.length - 1;
            if (!(u === "1" && a2(y)) && !I) {
          ...
          return C !== null ? this._setCountry(C) : !1;
        }
        ...
        _updateMaxLength() {
          let {
            ...
            validationNumberType: r,
          } = this.options;
          if (e && g.utils)
            if (this.selectedCountryData.iso2) {
              let u = g.utils.numberType[n],
                l = g.utils.getExampleNumber(
                  this.selectedCountryData.iso2,
                  !1,
                  u,
                  !0
              ...
              for (
                ;
                g.utils.isPossibleNumber(l, this.selectedCountryData.iso2, r);

              )
                (p = l), (l += "0");
              let y = g.utils.getCoreNumber(p, this.selectedCountryData.iso2);
              this.maxCoreNumberLength = y.length;
        ...
        _updatePlaceholder() {
          ...
          if (g.utils && l) {
            let p = g.utils.numberType[n],
              y = this.selectedCountryData.iso2
                ? g.utils.getExampleNumber(this.selectedCountryData.iso2, r, p)
                : "";
        ...
        _scrollTo(e) {
          let n = this.countryList,
            ...
            p = l + u,
            y = e.offsetHeight,
            C = e.getBoundingClientRect().top + r,
            S = C + y,
            I = C - l + n.scrollTop;
          if (C < l) n.scrollTop = I;
          else if (S > p) {
            let T = u - y;
            n.scrollTop = I - T;
          }
        ...
        _getFullNumber() {
          let e = this.telInput.value.trim(),
            { dialCode: n } = this.selectedCountryData,
            r,
            u = c1(e);
          return (
            this.options.separateDialCode && e.charAt(0) !== "+" && n && u
              ? (r = `+${n}`)
              : (r = ""),
            r + e
          );
        ...
        _formatNumberAsYouType() {
          let e = this._getFullNumber(),
            n = g.utils
              ? g.utils.formatNumberAsYouType(e, this.selectedCountryData.iso2)
              : e,
        ...
        getNumber(e) {
          if (g.utils) {
            ...
            return g.utils.formatNumber(this._getFullNumber(), n, e);
          }
          return "";
        }
        getNumberType() {
          return g.utils
            ? g.utils.getNumberType(
                this._getFullNumber(),
                this.selectedCountryData.iso2
              )
            : -99;
        ...
        _utilsIsValidNumber(e) {
          return g.utils
            ? g.utils.isValidNumber(e, this.selectedCountryData.iso2)
            : null;
        }
        setCountry(e) {
          let n = e?.toLowerCase(),
      ...
      V2 = (m) =>
        !g.utils && !g.startedLoadingUtilsScript
          ? ((g.startedLoadingUtilsScript = !0),
            new Promise((e, n) => {
              import_INTENTIONALLY_BROKEN(/* webpackIgnore: true */ m)
                .then(({ default: r }) => {
                  (g.utils = r), $1("handleUtils"), e(!0);
                })
                .catch(() => {
      ...
      g = Object.assign(
        ...
        },
        {
          ...
          getCountryData: () => K,
          getInstance: (m) => {
            let e = m.getAttribute("data-intl-tel-input-id");
    ...
    (function () {
      ...
      function H(d, t) {
        return d.j[t].l ? (P(d, t) ? d.h[t].length : 0) : P(d, t) ? 1 : 0;
      }
      function E(d, t, $) {
        (d.h[t] = $), d.g && (d.g[t] = $);
      }
      ...
      (r1.prototype.g = function (d) {
        ...
        (r1.prototype.h = function (d, t) {
          ...
          if (((d = d.s), d === String)) {
            ...
            d === Number &&
            typeof t == "string" &&
            (t === "Infinity" || t === "-Infinity" || t === "NaN" || w1.test(t))
          )
            return Number(t);
          return t;
        });
            ...
            d ||
              (A1 = d =
                i1(j, {
                  ...
                  1: { name: "general_desc", i: 11, type: _ },
                  2: { name: "fixed_line", i: 11, type: _ },
                  3: { name: "mobile", i: 11, type: _ },
                  4: { name: "toll_free", i: 11, type: _ },
                  5: { name: "premium_rate", i: 11, type: _ },
                  6: { name: "shared_cost", i: 11, type: _ },
                  7: { name: "personal_number", i: 11, type: _ },
                  8: { name: "voip", i: 11, type: _ },
                  21: { name: "pager", i: 11, type: _ },
                  25: { name: "uan", i: 11, type: _ },
                  27: { name: "emergency", i: 11, type: _ },
                  28: { name: "voicemail", i: 11, type: _ },
                  29: { name: "short_code", i: 11, type: _ },
                  30: { name: "standard_rate", i: 11, type: _ },
                  31: { name: "carrier_specific", i: 11, type: _ },
                  33: { name: "sms_services", i: 11, type: _ },
                  24: { name: "no_international_dialling", i: 11, type: _ },
      ...
      var g1 = {
        ...
        y2 = RegExp("[+\uFF0B]+"),
        Q = RegExp("^[+\uFF0B]+"),
        D1 = RegExp("([0-9\uFF10-\uFF19\u0660-\u0669\u06F0-\u06F9])"),
        v2 = RegExp("[+\uFF0B0-9\uFF10-\uFF19\u0660-\u0669\u06F0-\u06F9]"),
        I2 = /[\\\/] *x/,
        _2 = RegExp("[^0-9\uFF10-\uFF19\u0660-\u0669\u06F0-\u06F9A-Za-z#]+$"),
        b2 = /(?:.*?[A-Za-z]){3}.*/,
        S2 = RegExp(
      ...
      var x1 = new RegExp("(?:" + P1() + ")$", "i"),
        ...
        E2 = /^\(?\$1\)?$/;
      function R1(d) {
        return 2 > d.length ? !1 : B(w2, d);
      }
      function O1(d) {
        return B(b2, d) ? o1(d, C2) : o1(d, g1);
      }
      function k1(d) {
        var t = O1(d.toString());
        x(d), d.g(t);
      ...
      function B1(d) {
        return d != null && (H(d, 9) != 1 || N(d, 9)[0] != -1);
      }
      function o1(d, t) {
      ...
      A.prototype.format = function (d, t) {
        if (c(d, 2) == 0 && P(d, 5)) {
          var $ = v(d, 5);
          if (0 < $.length) return $;
        }
        $ = v(d, 1);
        var i = t1(d);
        if (t == 0) return H1($, 0, i, "");
        if (!($ in X)) return i;
        var o = d1(this, $, e1($));
        d =
          P(d, 3) && c(d, 3).length != 0
            ? t == 3
              ? ";ext=" + c(d, 3)
              : P(o, 13)
              ? c(o, 13) + v(d, 3)
            ...
            : "";
        d: {
          o = N(o, 20).length == 0 || t == 2 ? N(o, 19) : N(o, 20);
          for (var s, a = o.length, h = 0; h < a; ++h) {
            s = o[h];
            var f = H(s, 3);
            if (
              (f == 0 || i.search(c(s, 3, f - 1)) == 0) &&
              ((f = new RegExp(c(s, 1))), B(f, i))
            ) {
              o = s;
              break d;
            }
      ...
      function R(d, t) {
        var $ = d.length;
        return 0 < H(t, 9) && N(t, 9).indexOf($) == -1 ? !1 : B(v(t, 2), d);
      }
      function U1(d, t) {
        if (t == null) return null;
        var $ = v(t, 1);
      ...
      function a1(d, t, $, i) {
        var o = u1($, i),
          s = H(o, 9) == 0 ? N(c($, 1), 9) : N(o, 9);
        if (((o = N(o, 10)), i == 2))
          if (B1(u1($, 0)))
            (d = u1($, 1)),
              B1(d) &&
                ((s = s.concat(H(d, 9) == 0 ? N(c($, 1), 9) : N(d, 9))),
                s.sort(),
                o.length == 0
                  ? (o = N(d, 10))
                  : ((o = o.concat(N(d, 10))), o.sort()));
      ...
      function Y(d, t, $) {
        var i = t1(t);
        return (
          (t = v(t, 1)), t in X ? ((t = d1(d, t, e1(t))), a1(d, i, t, $)) : 1
        );
      }
      function K1(d, t) {
        if (((d = d.toString()), d.length == 0 || d.charAt(0) == "0")) return 0;
        for (var $, i = d.length, o = 1; 3 >= o && o <= i; ++o)
          if ((($ = parseInt(d.substring(0, o), 10)), $ in X))
            return t.g(d.substring(o)), $;
        return 0;
      }
      function V1(d, t, $, i, o, s) {
        ...
        var h = t.toString();
        if (h.length == 0) a = 20;
        else if (Q.test(h)) (h = h.replace(Q, "")), x(t), t.g(O1(h)), (a = 1);
        else {
          if (
            ((h = new RegExp(a)), k1(t), (a = t.toString()), a.search(h) == 0)
          ) {
            h = a.match(h)[0].length;
            var f = a.substring(h).match(D1);
            f && f[1] != null && 0 < f[1].length && o1(f[1], g1) == "0"
              ? (a = !1)
              : (x(t), t.g(a.substring(h)), (a = !0));
          } else a = !1;
          a = a ? 5 : 20;
        }
        if ((o && E(s, 6, a), a != 20)) {
          if (2 >= t.h.length) throw Error("Phone number too short after IDD");
          if (((d = K1(t, i)), d != 0)) return E(s, 1, d), d;
        ...
        return $ != null &&
          ...
          (f = t.toString()),
          f.lastIndexOf(h, 0) == 0 &&
            ((h = new w(f.substring(h.length))),
            (f = c($, 1)),
            (f = new RegExp(v(f, 2))),
            j1(h, $, null),
            (h = h.toString()),
            (!B(f, t.toString()) && B(f, h)) ||
              a1(d, t.toString(), $, -1) == 3))
          ? (i.g(h), o && E(s, 6, 10), E(s, 1, a), a)
          : (E(s, 1, 0), 0);
      }
      function j1(d, t, $) {
        var i = d.toString(),
        ...
        if (o != 0 && s != null && s.length != 0) {
          ...
          if ((o = a.exec(i))) {
            ...
            var h = B(s, i),
              f = o.length - 1;
            (t = c(t, 16)),
              t == null || t.length == 0 || o[f] == null || o[f].length == 0
                ? (!h || B(s, i.substring(o[0].length))) &&
                  ($ != null && 0 < f && o[f] != null && $.g(o[1]),
                  d.set(i.substring(o[0].length)))
                : ((i = i.replace(a, t)),
                  (!h || B(s, i)) &&
                    ($ != null && 0 < f && $.g(o[1]), d.set(i)));
          }
        }
      }
      function W(d, t, $) {
      ...
      function W1(d, t, $, i) {
        ...
        if (
          ...
          !a ||
            ...
            (s = o.toString()),
            (a = s.indexOf(";isub=")),
            0 < a && (x(o), o.g(s.substring(0, a))),
            !R1(o.toString())))
        )
          throw Error("The string supplied did not seem to be a phone number");
        if (
          ((s = o.toString()),
          !(s1($) || (s != null && 0 < s.length && Q.test(s))))
        )
          throw Error("Invalid country calling code");
        (s = new U()), i && E(s, 5, t);
        d: {
          if (
            ((t = o.toString()),
            (a = t.search(x1)),
            0 <= a && R1(t.substring(0, a)))
          ) {
            h = t.match(x1);
            for (var f = h.length, G = 1; G < f; ++G)
              if (h[G] != null && 0 < h[G].length) {
                x(o), o.g(t.substring(0, a)), (t = h[G]);
                break d;
              }
          }
          t = "";
        ...
        try {
          ...
          if (y1.message == "Invalid country calling code" && Q.test(f)) {
            if (((f = f.replace(Q, "")), (h = V1(d, f, a, t, i, s)), h == 0))
              throw y1;
          } else throw y1;
        }
        if (
          ...
          2 > t.h.length ||
            (a != null &&
              ...
              d != 2 &&
                ...
                d != 5 &&
                ((t = o),
                i && 0 < $.toString().length && E(s, 7, $.toString()))),
            (i = t.toString()),
            (d = i.length),
            2 > d))
        )
        ...
        if (1 < i.length && i.charAt(0) == "0") {
          for (E(s, 4, !0), d = 1; d < i.length - 1 && i.charAt(d) == "0"; )
            d++;
          d != 1 && E(s, 8, d);
        }
        return E(s, 2, parseInt(i, 10)), s;
      }
      function B(d, t) {
        return !!(
          (d =
            typeof d == "string" ? t.match("^(?:" + d + ")$") : t.match(d)) &&
          d[0].length == t.length
        );
      }
      function A2(d) {
      ...
      function Y1(d, t) {
        var $ = d.ga;
        return (t = s1(t) ? F1($, t) : 0), (d = F(d.ga, e1(t))), d ?? z1;
      }
      function J1(d) {
        for (var t = d.j.length, $ = 0; $ < t; ++$) {
          ...
          var f = s;
          a = v(a, 2);
          var G = "999999999999999".match(h)[0];
          if (
            (G.length < f.g.h.length
              ? (f = "")
              : ((f = G.replace(new RegExp(h, "g"), a)),
                (f = f.replace(RegExp("9", "g"), "\u2008"))),
            0 < f.length ? (s.v.g(f), (s = !0)) : (s = !1),
            s)
          )
            return (d.da = o), (d.ha = Z1.test(c(i, 4))), (d.$ = 0), !0;
        }
        return (d.u = !1);
      }
      function q1(d, t) {
      ...
      function M2(d, t) {
        ...
        var $ = t;
        if (
          (D1.test($) || (d.s.h.length == 1 && y2.test($))
            ? (t == "+"
                ? (($ = t), d.ba.g(t))
                : (($ = g1[t]), d.ba.g($), d.g.g($)),
              (t = $))
        ...
        switch (d.ba.h.length) {
          ...
          case 3:
            if (e2(d)) d.ea = !0;
            else return (d.o = t2(d)), C1(d);
          default:
            return d.ea
              ? ($2(d) && (d.ea = !1), d.h.toString() + d.g.toString())
              : 0 < d.j.length
              ? ((t = n2(d, t)),
                ($ = Q1(d)),
                0 < $.length
                  ? $
                  : (q1(d, d.g.toString()),
                    J1(d) ? d2(d) : d.u ? l1(d, t) : d.s.toString()))
              : C1(d);
        }
      }
      function X1(d) {
      ...
      function C1(d) {
        ...
        if (3 <= t.length) {
          for (
            ...
            var s = $[o];
            (0 < d.o.length && G1(v(s, 4)) && !c(s, 6) && !P(s, 5)) ||
              ((d.o.length != 0 || d.ca || G1(v(s, 4)) || c(s, 6)) &&
                N2.test(v(s, 2)) &&
                d.j.push(s));
          }
          return (
            q1(d, t),
            (t = Q1(d)),
            0 < t.length ? t : J1(d) ? d2(d) : d.s.toString()
          );
        }
        return l1(d, t);
      }
      function d2(d) {
        ...
        if (0 < $) {
          ...
          return d.u ? l1(d, i) : d.s.toString();
        }
        return d.h.toString();
      }
      function t2(d) {
      ...
      e("intlTelInputUtilsTemp", {}),
        ...
        e("intlTelInputUtilsTemp.isValidNumber", (d, t) => {
          try {
            ...
            var o = v($, 1),
              s = d1(d, o, i);
            if (s == null || (i != "001" && o != F1(d, i))) var a = !1;
            else {
              var h = t1($);
              a = m1(h, s) != -1;
            }
          ...
          try {
            ...
            if ($) {
              ...
              if ($ === "FIXED_LINE_OR_MOBILE") {
                let a = Y(i, o, h1.MOBILE) === 0,
                  h = Y(i, o, h1.FIXED_LINE) === 0;
                return a || h || s;
              }
              return s;
            }
        ...
        e("intlTelInputUtilsTemp.numberType", h1),
    ...
    var j2 = window.intlTelInputUtilsTemp;
